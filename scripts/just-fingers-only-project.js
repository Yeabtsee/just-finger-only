...
function chooseGame(playerChoice){
    ...
    const chooseGame = `<div class="choices" style="margin-bottom: 40px;">You chose <p class="choice-info"> ${playerChoice} </p>. The Computer chose <p class="choice-info"> ${computerChoice} </p>. 
            </div>
  ...
  function playGame(playerMove,playerChoice, computerChoice){
      ...
      <img src="emojis/${computerMove}-emoji.png" class="move-icon"> Computer. ${result}`
      const scoreUpdate =` 
